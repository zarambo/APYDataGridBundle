...
class DocumentTest extends TestCase
{
    ...
    public function testGetFieldsMetadataWithTitleOnly()
    {
        $name = 'propName';
        $this->arrangeGetFieldsMetadata($name, ['type' => 'text']);
    ...
    public function testGetFieldsMetadataWithFieldName()
    {
        $name = 'propName';
        $fieldName = 'fieldName';
        $this->arrangeGetFieldsMetadata($name, ['type' => 'text', 'fieldName' => $fieldName]);
    ...
    public function testGetFieldsMetadataWithIdButNotPrimary()
    {
        $name = 'propName';
        $this->arrangeGetFieldsMetadata($name, ['type' => 'text', 'id' => 'notId']);
    ...
    public function testGetFieldsMetadataWithPrimaryId()
    {
        $name = 'propName';
        $this->arrangeGetFieldsMetadata($name, ['type' => 'text', 'id' => 'id']);
    ...
    public function testGetFieldsMetadataWithIdType()
    {
        $this->assertGetFieldsMetadataWithType('id', 'text');
    }

    public function testGetFieldsMetadataWithStringType()
    {
        $this->assertGetFieldsMetadataWithType('string', 'text');
    }

    public function testGetFieldsMetadataWithBinCustomType()
    {
        $this->assertGetFieldsMetadataWithType('bin_custom', 'text');
    }

    public function testGetFieldsMetadataWithBinFuncType()
    {
        $this->assertGetFieldsMetadataWithType('bin_func', 'text');
    }

    public function testGetFieldsMetadataWithBinMd5Type()
    {
        $this->assertGetFieldsMetadataWithType('bin_md5', 'text');
    }

    public function testGetFieldsMetadataWithBinType()
    {
        $this->assertGetFieldsMetadataWithType('bin', 'text');
    }

    public function testGetFieldsMetadataWithBinUuidType()
    {
        $this->assertGetFieldsMetadataWithType('bin_uuid', 'text');
    }

    public function testGetFieldsMetadataWithFileType()
    {
        $this->assertGetFieldsMetadataWithType('file', 'text');
    }

    public function testGetFieldsMetadataWithKeyType()
    {
        $this->assertGetFieldsMetadataWithType('key', 'text');
    }

    public function testGetFieldsMetadataWithIncrementType()
    {
        $this->assertGetFieldsMetadataWithType('increment', 'text');
    }

    public function testGetFieldsMetadataWithIntType()
    {
        $this->assertGetFieldsMetadataWithType('int', 'number');
    }

    public function testGetFieldsMetadataWithFloatType()
    {
        $this->assertGetFieldsMetadataWithType('float', 'number');
    }

    public function testGetFieldsMetadataWithBooleanType()
    {
        $this->assertGetFieldsMetadataWithType('boolean', 'boolean');
    }

    public function testGetFieldsMetadataWithDateType()
    {
        $this->assertGetFieldsMetadataWithType('date', 'date');
    }

    public function testGetFieldsMetadataWithTimestampType()
    {
        $this->assertGetFieldsMetadataWithType('timestamp', 'date');
    }

    public function testGetFieldsMetadataWithCollectionType()
    {
        $this->assertGetFieldsMetadataWithType('collection', 'array');
    }

    public function testGetFieldsMetadataWithOneCardinalityWithoutReferenceType()
    {
        $this->assertGetFieldsMetadataWithType('one', 'array');
    }

    public function testGetFieldsMetadataWithOneCardinalityWithFalseReferenceType()
    {
        $name = 'propName';
        $fieldName = 'fieldName';
        $this->arrangeGetFieldsMetadata($name, ['type' => 'one', 'id' => 'id', 'fieldName' => $fieldName, 'reference' => 'aa']);
    ...
    public function testGetFieldsMetadataWithOneCardinalityWithReferenceType()
    {
        $name = 'propName';
        $fieldName = 'fieldName';
        $targetDocument = 'foo';

        $this->arrangeGetFieldsMetadata(
            $name,
            ['type' => 'one', 'id' => 'id', 'fieldName' => $fieldName, 'reference' => true, 'targetDocument' => $targetDocument]
        );
        ...
        $this->assertAttributeEquals([$name => $targetDocument], 'referencedMappings', $this->document);
    }

    public function testGetFieldsMetadataWithManyCardinalityType()
    {
        $name = 'propName';
        $fieldName = 'fieldName';
        $this->arrangeGetFieldsMetadata($name, ['type' => 'many', 'id' => 'id', 'fieldName' => $fieldName]);
    ...
    public function testGetFieldsMetadataWithNonConfiguredTypeMapsToText()
    {
        $name = 'propName';
        $fieldName = 'fieldName';
        $this->arrangeGetFieldsMetadata($name, ['type' => 'foo', 'id' => 'id', 'fieldName' => $fieldName]);
    ...
    {
        // @todo split in more than one test
    }

    public function testGetTotalCount()
    {
        // @todo implement after execute
    }
    ...
    private function assertGetFieldsMetadataWithType($fieldType, $expectedOutputType)
    {
        $name = 'propName';
        $fieldName = 'fieldName';
        $this->arrangeGetFieldsMetadata($name, ['type' => $fieldType, 'id' => 'id', 'fieldName' => $fieldName]);
